    ...
    var optimizelyCode = function() {
        var DATA = {
            ...
            "experiments": {
                ...
                "9864600837": {
                    "audiences": [5096592058],
                    "variation_weights": {
                        "9861420562": 5000,
                        "9861670539": 5000
                    },
                    "name": "Blog overlay to Home Page",
                    "enabled": true,
                    "variation_ids": ["9861420562", "9861670539"],
                    "ignore": 8000,
                    "urls": [{
                        "match": "substring",
                        "value": "https://blog.wishpond.com/"
                    }],
                    "enabled_variation_ids": ["9861420562", "9861670539"]
                }
            },
            "audiences": {
                "5096592058": {
                    "conditions": ["and", ["or", ["not", ["or", {
                        "dimension_id": 5098931955,
                        "match": "exists"
                    }]]]],
                    "name": "Hasn't seen blog overlay"
                },
                "1632632023": {
                    "conditions": ["and", ["or", ["not", ["or", {
            ...
            "version": "master-pci-356.406871505614961855",
            ...
            "variations": {
                ...
                "9861670539": {
                    "code": "$('#pricing-link').attr('href', 'https://www.wishpond.com/?blog_overlay=true');",
                    "name": "Variation #1"
                },
                "8927580812": {
                    "name": "Original"
