...
window._wpemojiSettings = {
    ...
    "svgExt": ".svg",
    "source": {
        "concatemoji": "https:\/\/www.wishpond.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=4.9.2"
    }
};
! function(a, b, c) {
    function d(a, b) {
...
document.querySelector('.navbar-brand img').src = "img/transdark.png";
$.getScript('https://d30itml3t0pwpf.cloudfront.net/wp-content/themes/wishpond/js/wishpond-scripts/scrollreveal.min.js', function() {
    ...
    sr.reveal(document.querySelectorAll('.features img'), {
        duration: 800,
        viewFactor: 0.7
    });
});
