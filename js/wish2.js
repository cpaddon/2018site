...
$(window).on("scroll", function() {
    ...
    /*var $sec1 = $('#features').offset().top;
    var $sec2 = $('#b2bsalesteams').offset().top;
    var $sec3 = $('#marketplaces').offset().top;
    var $sec4 = $('#lead-tracking').offset().top;
    var $sec5 = $('#routing').offset().top;
    var $sec6 = $('#enrichment').offset().top;
    var $sec7 = $('#get-started').offset().top;*/

    var $sec1 = $('#features').offset().top;
    var $sec2 = $('#b2bsalesteams').offset().top;
    var $sec3 = $('#marketplaces').offset().top;
    var $sec4 = $('#custom').offset().top;
    var $sec5 = $('#routing').offset().top;
    var $sec6 = $('#enrichment').offset().top;
    var $sec7 = $('#get-started').offset().top;
    ...
    if ($(this).scrollTop() >= $sec1 && $(this).scrollTop() <= $sec2) {
        $('.items-index [href="#features"]').addClass('is-selected');
        $('.items-index :not([href="#features"])').removeClass('is-selected');
    }
    if ($(this).scrollTop() >= $sec2 && $(this).scrollTop() <= $sec3) {
        $('.items-index [href="#b2bsalesteams"]').addClass('is-selected');
        $('.items-index :not([href="#b2bsalesteams"])').removeClass('is-selected');
    }
    if ($(this).scrollTop() >= $sec3 && $(this).scrollTop() <= $sec4) {
        $('.items-index [href="#marketplaces"]').addClass('is-selected');
        $('.items-index :not([href="#marketplaces"])').removeClass('is-selected');
    }
    if ($(this).scrollTop() >= $sec4 && $(this).scrollTop() <= $sec5) {
        $('.items-index [href="#custom"]').addClass('is-selected');
        $('.items-index :not([href="#custom"])').removeClass('is-selected');
    }
    if ($(this).scrollTop() >= $sec5 && $(this).scrollTop() <= $sec6) {
        $('.items-index [href="#routing"]').addClass('is-selected');
        $('.items-index :not([href="#routing"])').removeClass('is-selected');
    }
    if ($(this).scrollTop() >= $sec6 && $(this).scrollTop() <= $sec7) {
        $('.items-index [href="#enrichment"]').addClass('is-selected');
        $('.items-index :not([href="#enrichment"])').removeClass('is-selected');
    }
