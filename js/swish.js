...
$('.hero-container a').on('click', slideLearn);
$(function() {
    $('.nav-tabs a').on('click', selectNavRadio);

    function selectNavRadio() {
        $('.switch[href="' + this.hash + '"]').click();
    }
    ...
    function selectRadio(e) {
        ...
        $('.nav-tabs a[href="' + id + '"]').addClass('active').attr('aria-selected', 'true');
        $('.nav-tabs a:not([href="' + id + '"])').removeClass('active').attr('aria-selected', 'false');
    ...
    function switchSections(el, shouldScroll) {
        ...
        $('.content-section[data-toggle^="#"]').not('[data-toggle="' + el + '"]').fadeOut(function() {
            $('.content-section[data-toggle="' + el + '"]').fadeIn(function() {
                if (shouldScroll) {
                    $('html, body').stop().animate({
...
*/               }
        ...
        $('.learn-more').attr('href', ctaContent[el][1]);
        $('.demo-nav a').attr('href', demoNavHref + '&utm_campaign=' + ctaContent[el][2]);
        $('footer').fadeIn();
        if (el.indexOf('fully-managed') > -1) {
            $('nav').addClass('nav-fully-managed');
        } else {
            $('nav').removeClass('nav-fully-managed');
        }
    }
    ...
    if (window.location.hash) {
        ...
        $(pageHash).prop('checked', true);
        $('.nav-tabs a[href="' + pageHash + '"]').addClass('active').attr('aria-selected', 'true');
        $('.nav-tabs a:not([href="' + pageHash + '"])').removeClass('active').attr('aria-selected', 'false');
        ...
        $('.nav-tabs a[href="' + serviceId + '"]').addClass('active').attr('aria-selected', 'true');
        $('.nav-tabs a:not([href="' + serviceId + '"])').removeClass('active').attr('aria-selected', 'false');
    } else {
...
var topofDiv = $("#inline-switch").offset().top;
var height = $("#inline-switch").outerHeight();
$(window).scroll(function() {
    if ($(window).scrollTop() > (topofDiv + height)) {
        $('nav').addClass('nav-drop');
    } else {
